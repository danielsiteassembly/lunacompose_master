...
add_action('wp_footer', function () {
  ...
  if ($mode === 'widget') {
    ...
    <style>
      ...
      .luna-launcher{display:flex;align-items:center;gap:10px;background:#111;color:#fff4e9;border:1px solid #5A5753;border-radius:999px;padding:8px 17px 8px 8px;cursor:pointer;box-shadow:0 8px 24px rgba(0,0,0,.25)}
  ...
  register_rest_route('luna_widget/v1', '/widget/html', array(
    ...
    'callback' => function( WP_REST_Request $req ){
      ...
      $css = "
        ...
        .luna-launcher{display:flex;align-items:center;gap:10px;background:#111;color:#fff4e9;border:1px solid #5A5753;border-radius:999px;padding:8px 17px 8px 8px;cursor:pointer;box-shadow:0 8px 24px rgba(0,0,0,.25);width:100%;max-width:215px;}
